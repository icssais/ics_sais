<?php
	...
	/* get instructor current advisees */
	...
	//fetch instructor current advisees
	...
	if($row==null)
		echo
			"<tr>
				<td colspan='3' style='text-align: center;'><i>You have no current advisees.</i></td>
			</tr>
			";
	else{
?>
...
<?php
		do{
			...
			<tr>
				...
				<td>{$row["start_sem"]}, {$row["start_year"]} to Present</td>
			</tr>";
