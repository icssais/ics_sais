<?php
	$student_no=$stud_num;
	require "process/encoder/get_total_units_earned.php";
	...
	if($row==null)
		...
		do{
			...
			require "process/encoder/get_total_units_sem.php";
			require "process/encoder/get_scholastic_standing.php";
			require "process/encoder/get_gpa.php";
			echo "</br>";
		...
		require "process/encoder/get_gwa.php";
