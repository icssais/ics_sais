...
<div class="section_content" id="viewUser_section">
	<div class="section_label" id="view_student">
		<label>Student</label>
	</div>
	<div id="viewStudent">
		<table style="margin-left:50px; text-align:center;" class='view_table'>
			...
			<?php
				...
				while($row=mysql_fetch_array($found)){
					echo "<tr>";?>
						<td><a class='simple_submit' href="index.php?action=viewStudentProfile&username=<?php echo $row['username'] ?>"><?php echo $row['username'];?></a></td>
					<?php echo"
